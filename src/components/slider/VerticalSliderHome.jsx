...
const VerticalSliderHome = memo(({ sliderData, containerFluid }) => {
    ...
    const {
        ...
        setSelectedVideoArray,
    } = useViewData(); // Extract the context functions

    const handlePlayNow = (data) => {
        setVideoUrls(data.video_url); // Set the video URL
        setSelectedVideoData(data); // Set the selected video data
        setSelectedVideoArray(sliderData); // Set the array of videos
        navigate("/movies-detail"); // Navigate to the movie detail page
    };

    return (
        <Fragment>
            <div className="verticle-slider section-padding-bottom h-75"> {/* Adjust height with Bootstrap */}
...
VerticalSliderHome.displayName = "VerticalSliderHome";
export default VerticalSliderHome;
